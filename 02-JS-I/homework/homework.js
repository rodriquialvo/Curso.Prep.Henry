...
function esVocal(letra){
  //Escribe una función que reciba una 
  //letra y, si es una vocal, muestre el mensaje “Es vocal”. 
  //Verificar si el usuario 
  //ingresó un string de más de un carácter y,
  //en ese caso, informarle 
  //que no se puede procesar el 
  //dato mediante el mensaje "Dato incorrecto".
  //Escribe tu código aquí
  var vocal = "Es vocal";
